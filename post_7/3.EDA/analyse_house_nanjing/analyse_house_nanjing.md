...
```
    ...
    <matplotlib.text.Text at 0x1114e2710>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x11b806590>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x112e6d650>
...
```
    ...
    ('Best l1_ratio :', 0.84999999999999998)
    ('Best alpha :', 6.0000000000000002e-05)
    ('ElasticNet RMSE on Training set :', 0.27743421100902294)
    ('ElasticNet RMSE on Test set :', 0.2745439282146373)
...
![png](output_35_2.png)
    ...
    ElasticNet picked 70 features and eliminated the other 17 features
